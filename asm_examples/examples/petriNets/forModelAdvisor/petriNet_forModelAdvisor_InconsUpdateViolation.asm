asm petriNet_forModelAdvisor_InconsUpdateViolation
...
definitions:
	...
	function inArcWeight($p in Place, $t in Transition) = 1

 	function outArcWeight($t in Transition, $p in Place) = 1
	...
	function capacity($p in Place) = 3
...
default init s0:
	 //initial marking
 	function tokens($p in Place) = at({p1 -> 1}, $p) 
