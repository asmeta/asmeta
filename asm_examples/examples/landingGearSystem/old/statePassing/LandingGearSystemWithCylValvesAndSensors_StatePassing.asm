...
//c'è un passaggio di stato tra l'attivazione del sensore e il cambiamento dello stato della porta

asm LandingGearSystemWithCylValvesAndSensors_StatePassing
