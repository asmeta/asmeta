asm MorraCinese_withActors_raff3
...
//il computer e l'utente sono in parita', permettere che continuino a giocare
...
definitions:
	...
	main rule r_Main =
		...
		if((numberOfPlays < maxNumberOfPlays) or
			(numberOfPlays >= maxNumberOfPlays and wins(user) = wins(computer))) then
			par
