...
// RULE DEFINITIONS
	...
	//R-14
	//uguale a R-2 perch� patient connection avviene durante phase therapy initiation
	...
	//R-17
	//uguale a R-4 perch� patient connection avviene durante phase therapy initiation
	...
	main rule r_Main =
		par
			r_run_therapy[] 
			if errorExists then r_run_error[] endif
			if alarmExists then	r_run_alarm[] endif
		endpar
