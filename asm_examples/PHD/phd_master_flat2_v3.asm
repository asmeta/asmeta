...
rule r_63 = if status = DISASSOCIATING and transition = RX_RORS then par status := UNASSOCIATED message := MSG_NO_RESPONSE endpar endif
	...
	rule r_64 = if status = UNASSOCIATED and transition = RX_AARQ_INVALID then par status := UNASSOCIATED message := MSG_RX_AARE endpar endif
	rule r_65 = if status = UNASSOCIATED and transition = RX_AARQ_EXTERNAL then par status := UNASSOCIATED message := MSG_RX_AARE endpar endif

	main rule r_Main = par r_1[] r_2[] r_3[] r_4[] r_5[] r_6[] r_7[] r_8[] r_9[] r_10[] r_11[] r_12[] r_13[] r_14[] r_15[] r_16[] r_17[] r_18[] r_19[] r_20[] r_21[] r_22[] r_23[] r_24[] r_25[] r_26[] r_27[] r_28[] r_29[] r_30[] r_31[] r_32[] r_33[] r_34[] r_35[] r_36[] r_37[] r_38[] r_39[] r_40[] r_41[] r_42[] r_43[] r_44[] r_45[] r_46[] r_47[] r_48[] r_49[] r_50[] r_51[] r_52[] r_53[] r_54[] r_55[] r_56[] r_57[] r_58[] r_59[] r_60[] r_61[] r_62[] r_63[] r_64[] r_65[] endpar
