...
//modified version of certifierRaff4 for doing refinement proof
//domain "Answers" has been renamed as "AnswersRaff4"
asm certifierRaff4ForSMTproof
...
signature:
// DOMAINS
	enum domain AnswersRaff4={ SKIPRAFF4 | EXITRAFF4 | AA | BB | CC | DD}  //risoste che pu� dare l'utente: salta, esci, figura AA, BB, CC, DD
...
// FUNCTIONS
	...
	dynamic controlled currentAnswer: AnswersRaff4 //oggetto da indovinare
	dynamic monitored getAnswer: AnswersRaff4 //risposta dell'utente
...
// RULE DEFINITIONS
	...
	macro rule r_chooseshape=
		choose $x in AnswersRaff4 with $x!=EXITRAFF4 and $x!=SKIPRAFF4 do
			currentAnswer := $x
	...
	macro rule r_checkanswer($a in AnswersRaff4)=
