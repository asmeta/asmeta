...
signature:
	...
	enum domain State = { AWAITCARD | AWAITPIN | CHOOSE |  VIEWBALANCE |CHOOSESIZEMONEY | 
							WITHDRAWAL | STATEMENT | FINISH |OUTOFSERVICE}
							
	enum domain Service = {BALANCE | WITHDRAWAL_SERVICE | STATEMENT_SERVICE}
...
definitions:
	...
	function isInHierState($t in Till) = (tillState($t) = CHOOSE or 
										tillState($t) = VIEWBALANCE or
								tillState($t) = WITHDRAWAL or tillState($t) = STATEMENT) 
