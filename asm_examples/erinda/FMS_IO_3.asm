...
// functions 
    ...
    dynamic controlled cpm_label_group_1_1 : Cpm_label_name_group_1_1 -> Prod(Label_IN1_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_2 : Cpm_label_name_group_1_2 -> Prod(Label_IN2_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_3 : Cpm_label_name_group_1_3 -> Prod(Label_IN3_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_4 : Cpm_label_name_group_1_4 -> Prod(Label_IN4_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_5 : Cpm_label_name_group_1_5 -> Prod(Label_IN5_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_6 : Cpm_label_name_group_1_6 -> Prod(Label_IN6_value,Label_OUT1_validity)
    dynamic controlled cpm_label_group_1_7 : Cpm_label_name_group_1_7 -> Prod(Label_IN7_value,Label_OUT1_validity)          
...
dynamic controlled cpm_label_group_2_1 : Cpm_label_name_group_2_1 -> Prod(Label_IN8_value,Label_OUT2_validity)
dynamic controlled cpm_label_group_2_2 : Cpm_label_name_group_2_2 -> Prod(Label_IN9_value,Label_OUT2_validity)
dynamic controlled cpm_label_group_2_3 : Cpm_label_name_group_2_3 -> Prod(Label_IN10_value,Label_OUT2_validity)
dynamic controlled cpm_label_group_2_4 : Cpm_label_name_group_2_4 -> Prod(Label_IN11_value,Label_OUT2_validity)
dynamic controlled cpm_label_group_2_5 : Cpm_label_name_group_2_5 -> Prod(Real,Label_OUT2_validity)
dynamic controlled cpm_label_group_2_6 : Cpm_label_name_group_2_6 -> Prod(Label_IN7_value,Label_OUT2_validity)                      
...
dynamic controlled cpm_label_group_3_1 : Cpm_label_name_group_3_1 -> Prod(Label_IN7_value,Label_OUT3_validity)
dynamic controlled cpm_label_group_3_2 : Cpm_label_name_group_3_2 -> Prod(Label_IN12_value,Label_OUT3_validity)
dynamic controlled cpm_label_group_3_3 : Cpm_label_name_group_3_3 -> Prod(Label_IN13_value,Label_OUT3_validity)
dynamic controlled cpm_label_group_3_4 : Cpm_label_name_group_3_4 -> Prod(Label_IN14_value,Label_OUT3_validity)
dynamic controlled cpm_label_group_3_5 : Cpm_label_name_group_3_5 -> Prod(Real,Label_OUT3_validity) 

static label_1_1 : Prod(Label_IN1_value, Label_IN1_validity) -> Prod(Label_IN1_value, Label_OUT1_validity)
static label_1_2 : Prod(Label_IN2_value, Label_IN1_validity) -> Prod(Label_IN2_value, Label_OUT1_validity)
static label_1_3 : Prod(Label_IN3_value, Label_IN1_validity) -> Prod(Label_IN3_value, Label_OUT1_validity)
static label_1_4 : Prod(Label_IN4_value, Label_IN1_validity) -> Prod(Label_IN4_value, Label_OUT1_validity)
static label_1_5 : Prod(Label_IN5_value, Label_IN1_validity) -> Prod(Label_IN5_value, Label_OUT1_validity)
static label_1_6 : Prod(Label_IN6_value, Label_IN1_validity) -> Prod(Label_IN6_value, Label_OUT1_validity)
static label_1_7 : Prod(Label_IN7_value, Label_IN1_validity) -> Prod(Label_IN7_value, Label_OUT1_validity)

static label_2_1 : Prod(Label_IN8_value, Label_IN2_validity) -> Prod(Label_IN8_value, Label_OUT2_validity)
static label_2_2 : Prod(Label_IN9_value, Label_IN2_validity) -> Prod(Label_IN9_value, Label_OUT2_validity)
static label_2_3 : Prod(Label_IN10_value, Label_IN2_validity) -> Prod(Label_IN10_value, Label_OUT2_validity)
static label_2_4 : Prod(Label_IN11_value, Label_IN2_validity) -> Prod(Label_IN11_value, Label_OUT2_validity)
static label_2_5 : Prod(Real, Label_IN2_validity) -> Prod(Real, Label_OUT2_validity)
static label_2_6 : Prod(Label_IN7_value, Label_IN2_validity) -> Prod(Label_IN7_value, Label_OUT2_validity)

static label_3_1 : Prod(Label_IN7_value, Label_IN3_validity) -> Prod(Label_IN7_value, Label_OUT3_validity)
static label_3_2 : Prod(Label_IN12_value, Label_IN3_validity) -> Prod(Label_IN12_value, Label_OUT3_validity)
static label_3_3 : Prod(Label_IN13_value, Label_IN3_validity) -> Prod(Label_IN13_value, Label_OUT3_validity)
static label_3_4 : Prod(Label_IN14_value, Label_IN3_validity) -> Prod(Label_IN14_value, Label_OUT3_validity)
static label_3_5 : Prod(Real, Label_IN3_validity) -> Prod(Real, Label_OUT3_validity)
...
macro rule r_read_grouplabel1 = 
                      ...
                      cpm_label_group_1_1(CPM_326_LATERAL_SCALE_FACTOR) := label_1_1(first(label_group_1_1(LATERAL_SCALE_FACTOR)), second(label_group_1_1(LATERAL_SCALE_FACTOR)))
                           ...
                           cpm_label_group_1_3(CPM_173_PSEUDO_LOC_DEVIATION) := label_1_3(first(label_group_1_3(PSEUDO_LOC_DEVIATION)), second(label_group_1_3(PSEUDO_LOC_DEVIATION)))
                           
                           cpm_label_group_1_4(CPM_174_PSEUDO_GS_DEVIATION) := label_1_4(first(label_group_1_4(PSEUDO_GS_DEVIATION)), second(label_group_1_4(PSEUDO_GS_DEVIATION)))
 
                           cpm_label_group_1_5(CPM_177_DISTANCE_TO_FPCP) := label_1_5(first(label_group_1_5(DISTANCE_TO_FPCP)), second(label_group_1_5(DISTANCE_TO_FPCP)))
                            
                           cpm_label_group_1_6(CPM_322_PSEUDO_GS_PATH_ANGLE) := label_1_6(first(label_group_1_6(PSEUDO_GS_PATH_ANGLE)), second(label_group_1_6(PSEUDO_GS_PATH_ANGLE)))
                           
                           cpm_label_group_1_7(CPM_105_SELECTED_RUNWAY_HEADING) := label_1_7(first(label_group_1_7(SELECTED_RUNWAY_HEADING)), second(label_group_1_7(SELECTED_RUNWAY_HEADING)))                                                                                                           
                          endpar
...
macro rule r_read_grouplabel2 = par
                            ...
                            cpm_label_group_2_2(CPM_FMS_BUS_INERT_VERTICAL_SPEED) := label_2_2(first(label_group_2_2(SEL_AHRS_VERT_VEL_INERT)), second(label_group_2_2(SEL_AHRS_VERT_VEL_INERT)))                            
 
                            cpm_label_group_2_3(CPM_FMS_BUS_TRUE_AIRSPEED) := label_2_3(first(label_group_2_3(SEL_ADU_TRUE_AIRSPEED)), second(label_group_2_3(SEL_ADU_TRUE_AIRSPEED)))
                             
                            cpm_label_group_2_4(CPM_FMS_BUS_RADIO_HEIGHT) := label_2_4(first(label_group_2_4(SEL_RA_ALTITUDE)), second(label_group_2_4(SEL_RA_ALTITUDE)))
                             
                            cpm_label_group_2_5(CPM_FMS_BUS_AIRCRAFT_MAG_HEADING) := label_2_5(first(label_group_2_5(AIRCRAFT_MAG_HEADING)), second(label_group_2_5(AIRCRAFT_MAG_HEADING)))
                            cpm_label_group_2_5(CPM_FMS_BUS_GROUND_SPEED) := label_2_5(first(label_group_2_5(GROUND_SPEED)), second(label_group_2_5(GROUND_SPEED)))
                            cpm_label_group_2_5(CPM_FMS_BUS_TRACK_ANGLE) := label_2_5(first(label_group_2_5(TRACK_ANGLE)), second(label_group_2_5(TRACK_ANGLE)))
                            cpm_label_group_2_5(CPM_FMS_BUS_ROLL_ANGLE) := label_2_5(first(label_group_2_5(ROLL_ANGLE)), second(label_group_2_5(ROLL_ANGLE)))
                            cpm_label_group_2_5(CPM_FMS_BUS_WIND_SPEED) := label_2_5(first(label_group_2_5(SEL_WIND_AT_ALT_SPEED)), second(label_group_2_5(SEL_WIND_AT_ALT_SPEED)))
                            cpm_label_group_2_5(CPM_FMS_BUS_WIND_ANGLE) := label_2_5(first(label_group_2_5(SEL_WIND_AT_ALT_ANGLE)), second(label_group_2_5(SEL_WIND_AT_ALT_ANGLE)))
                                                                                                                                                                         
                            cpm_label_group_2_6(CPM_FMS_BUS_TRUE_HEADING) := label_2_6(first(label_group_2_6(BEST_TRUE_HEADING)), second(label_group_2_6(BEST_TRUE_HEADING)))                                                                                       
                           endpar
...
macro rule r_read_grouplabel3 = par
                            ...
                            cpm_label_group_3_1(CPM_MON_ST_AMMC_DEAD_REC_LONGITUDE_DATA) := label_3_1(first(label_group_3_1(AMMC_LONG)), second(label_group_3_1(AMMC_LONG)))
                            cpm_label_group_3_1(CPM_MON_ST_BEST_LONGITUDE_DATA) := label_3_1(first(label_group_3_1(BEST_LONG)), second(label_group_3_1(BEST_LONG)))
                            cpm_label_group_3_1(CPM_MON_ST_DME_DME_LONGITUDE_DATA) := label_3_1(first(label_group_3_1(DME_DME_LONG)), second(label_group_3_1(DME_DME_LONG)))
                            cpm_label_group_3_1(CPM_MON_ST_VOR_DME_LONGITUDE_DATA) := label_3_1(first(label_group_3_1(VOR_DME_LONG)), second(label_group_3_1(VOR_DME_LONG)))
    
                            cpm_label_group_3_2(CPM_MON_ST_POSN_DIFF_CIVIL_GPS1) := label_3_2(first(label_group_3_2(POSN_DIFF_CIVIL_GPS1)), second(label_group_3_2(POSN_DIFF_CIVIL_GPS1)))
                            cpm_label_group_3_2(CPM_MON_ST_POSN_DIFF_CIVIL_GPS2) := label_3_2(first(label_group_3_2(POSN_DIFF_CIVIL_GPS2)), second(label_group_3_2(POSN_DIFF_CIVIL_GPS2)))
                            cpm_label_group_3_2(CPM_MON_ST_POSN_DIFF_DME_DME) := label_3_2(first(label_group_3_2(POSN_DIFF_DME_DME)), second(label_group_3_2(POSN_DIFF_DME_DME)))
                            cpm_label_group_3_2(CPM_MON_ST_POSN_DIFF_VOR_DME) := label_3_2(first(label_group_3_2(POSN_DIFF_VOR_DME)), second(label_group_3_2(POSN_DIFF_VOR_DME)))
                            cpm_label_group_3_2(CPM_MON_ST_POSN_DIFF_AMMC) := label_3_2(first(label_group_3_2(POSN_DIFF_AMMC)), second(label_group_3_2(POSN_DIFF_AMMC)))

                            cpm_label_group_3_3(CPM_MON_ST_GPS1_LATITUDE) := label_3_3(first(label_group_3_3(CIVIL_GPS1_LATITUDE)), second(label_group_3_3(CIVIL_GPS1_LATITUDE)))
                            cpm_label_group_3_3(CPM_MON_ST_GPS2_LATITUDE) := label_3_3(first(label_group_3_3(CIVIL_GPS2_LATITUDE)), second(label_group_3_3(CIVIL_GPS2_LATITUDE)))
                            cpm_label_group_3_3(CPM_MON_ST_INIT_LATITUDE) := label_3_3(first(label_group_3_3(INIT_LAT)), second(label_group_3_3(INIT_LAT)))
                            cpm_label_group_3_3(CPM_MON_ST_AMMC_DEAD_REC_LATITUDE) := label_3_3(first(label_group_3_3(AMMC_LAT)), second(label_group_3_3(AMMC_LAT)))
                            cpm_label_group_3_3(CPM_MON_ST_BEST_LATITUDE) := label_3_3(first(label_group_3_3(BEST_LAT)), second(label_group_3_3(BEST_LAT)))
                            cpm_label_group_3_3(CPM_MON_ST_DME_DME_LATITUDE) := label_3_3(first(label_group_3_3(DME_DME_LAT)), second(label_group_3_3(DME_DME_LAT)))
                            cpm_label_group_3_3(CPM_MON_ST_VOR_DME_LATITUDE) := label_3_3(first(label_group_3_3(VOR_DME_LAT)), second(label_group_3_3(VOR_DME_LAT)))

                            cpm_label_group_3_4(CPM_MON_ST_BEST_POSN_SOURCE) := label_3_4(first(label_group_3_4(BEST_POSN_SOURCE)), second(label_group_3_4(BEST_POSN_SOURCE)))                            

                            cpm_label_group_3_5(CPM_MON_ST_BEST_BAR_ALT_CORR) := label_3_5(first(label_group_3_5(SEL_ADU_BARO_CORR_ALTITUDE)), second(label_group_3_5(SEL_ADU_BARO_CORR_ALTITUDE))) 
                            cpm_label_group_3_5(CPM_MON_ST_BEST_MSL_ALT) := label_3_5(first(label_group_3_5(BEST_MSL_ALT)), second(label_group_3_5(BEST_MSL_ALT)))
                           endpar                     	   
...
//gestione del tempo di spedizione delle label sui bus corrispondenti sui canali corrispondenti  	
	macro rule r_read_labels =
	                        par 
	                          ...
	                          if timer != 0 then
	                           par                            
	                            if (nexttimer mod 20) = 0 then r_read_grouplabel1[]	                            
	                            endif 
	                            if (nexttimer mod 40) = 0 then r_read_grouplabel2[]	                                                                                                                                                                   
	                            endif
	                            if (nexttimer mod 320) = 0 then r_read_grouplabel3[]	                             
	                            endif
	                           endpar	                              	                            
	                          endif
...
function cpm_label_group_1_1($n in Cpm_label_name_group_1_1) = (0.0, NCD)
function cpm_label_group_1_2($n in Cpm_label_name_group_1_2) = (NAV, NCD)
function cpm_label_group_1_3($n in Cpm_label_name_group_1_3) = (0.0, NCD)
function cpm_label_group_1_4($n in Cpm_label_name_group_1_4) = (0.0, NCD)
function cpm_label_group_1_5($n in Cpm_label_name_group_1_5) = (0.0, NCD)
function cpm_label_group_1_6($n in Cpm_label_name_group_1_6) = (0.0, NCD)
function cpm_label_group_1_7($n in Cpm_label_name_group_1_7) = (0.0, NCD)

function cpm_label_group_2_1($n in Cpm_label_name_group_2_1) = (0.0, NO_COMPUTED_DATA)  
function cpm_label_group_2_2($n in Cpm_label_name_group_2_2) = (0.0, NO_COMPUTED_DATA)  
function cpm_label_group_2_3($n in Cpm_label_name_group_2_3) = (0.0, NO_COMPUTED_DATA) 
function cpm_label_group_2_4($n in Cpm_label_name_group_2_4) = (0.0, NO_COMPUTED_DATA) 
function cpm_label_group_2_5($n in Cpm_label_name_group_2_5) = (0.0, NO_COMPUTED_DATA)  
function cpm_label_group_2_6($n in Cpm_label_name_group_2_6) = (0.0, NO_COMPUTED_DATA)  
 
function cpm_label_group_3_1($n in Cpm_label_name_group_3_1) = (0.0, NCD3)
function cpm_label_group_3_2($n in Cpm_label_name_group_3_2) = (0.0, NCD3)
function cpm_label_group_3_3($n in Cpm_label_name_group_3_3) = (0.0, NCD3)
function cpm_label_group_3_4($n in Cpm_label_name_group_3_4) = (NONE, NCD3)
function cpm_label_group_3_5($n in Cpm_label_name_group_3_5) = (0.0, NCD3)
