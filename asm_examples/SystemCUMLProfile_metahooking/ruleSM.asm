...
signature:
	 ...
	 * affinchè non si risetti lo stato corrente allo stato iniziale
	 */
...
if //(
	...
	/*Questa esclusione perchè in realtàe altre transizioni continuano a verificare le rispettive condizioni
...
then true
	...
	if isDef(asState($p)) and isSimple(asState($p))//cioè se $p è no stato ed è semplice
