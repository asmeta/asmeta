asm mainForModelCheckingNoSelfHealerNoFailures
...
definitions:
	...
	*/
	...
	CTLSPEC ag((congested(organizationController1) and congested(organizationController2) and stateC(c2) = MASTER) implies
	 			ef(stateC(c1) = MASTERWITHSLAVES and slaves(c1,c2) and stateC(c2) = SLAVE))
	CTLSPEC ag((not(congested(organizationController1)) and congested(organizationController2) and congested(organizationController3)) implies
	 			ef(stateC(c2) = MASTERWITHSLAVES and slaves(c2,c3) and stateC(c3) = SLAVE))
