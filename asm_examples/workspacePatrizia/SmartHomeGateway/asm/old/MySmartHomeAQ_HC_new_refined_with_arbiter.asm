asm MySmartHomeAQ_HC_new_refined_with_arbiter
...
function airLevel ($v in Integer) = 
	...
	function startHighAQ_HCA($b in HighAQ_HCMgA) = //Refined
	  ...
	  sgnMainHCPtoHighA($b) and sgnMainAQAtoHighA($b)
...
rule r_checkAirAdaptationRequired =
	...
	rule r_CleanUp_MainHCE =
	 par 
		 ...
		 //sgnMainHCPtoHighA(self):= false//PA April 1, 2019
	...
	rule r_MainHCE =//refined
		if startMainHCE(self) then
		   ...
		   par
			 //sgnMainHCPtoHighA(self):= false//PA change April 1, 2019
