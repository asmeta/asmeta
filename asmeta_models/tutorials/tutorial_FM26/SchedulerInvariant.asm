 ...
 * 
 * In this version we have added the invariants and the properties (not related to this tutorial)
 */
...
definitions:
	...
	invariant inv_fin over Status : (forall $j in Job with fin($j) implies st($j) = RUN)		
