...
public class AvallaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AvallaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPickAccess().getGroup(), "rule__Pick__Group__0");
			builder.put(grammarAccess.getPickAccess().getGroup_2(), "rule__Pick__Group_2__0");
			...
			builder.put(grammarAccess.getPickAccess().getVarAssignment_1(), "rule__Pick__VarAssignment_1");
			builder.put(grammarAccess.getPickAccess().getRuleAssignment_2_1(), "rule__Pick__RuleAssignment_2_1");
			builder.put(grammarAccess.getPickAccess().getValueAssignment_4(), "rule__Pick__ValueAssignment_4");
