...
public abstract class AbstractAvallaSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AvallaPackage.eINSTANCE)
			...
			case AvallaPackage.SET:
				sequence_Set(context, (asmeta.avallaxt.avalla.Set) semanticObject); 
				return; 
	 ...
	 * </pre>
	 */
	protected void sequence_Set(ISerializationContext context, asmeta.avallaxt.avalla.Set semanticObject) {
		if (errorAcceptor != null) {
