 ...
 */
package asmeta.avallaxt.services;
...
public class AvallaGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ScenarioElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Scenario");
	...
	public class InvariantElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Invariant");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Element");
	...
	public class CommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Command");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class CheckElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Check");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SetElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Set");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StepElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Step");
	...
	public class StepUntilElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.StepUntil");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExecElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Exec");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BlockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Block");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExecBlockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.ExecBlock");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PathElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.Path");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SentenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.sentence");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SentencePlusAssignElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.sentencePlusAssign");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cGOOD_CHARS_NO_COLONTerminalRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
	...
	public AvallaGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.STRING");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.ML_COMMENT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.SL_COMMENT");
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.WS");
		this.pSentence = new SentenceElements();
		this.pSentencePlusAssign = new SentencePlusAssignElements();
		this.tGOOD_CHAR_NO_COLON = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.GOOD_CHAR_NO_COLON");
		this.tGOOD_CHARS_NO_COLON = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "asmeta.avallaxt.Avalla.GOOD_CHARS_NO_COLON");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("asmeta.avallaxt.Avalla".equals(grammar.getName())) {
				return grammar;
			}
