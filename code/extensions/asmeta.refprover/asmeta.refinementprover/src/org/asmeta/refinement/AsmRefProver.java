...
public class AsmRefProver {
	...
	public void doMain(String[] args) throws Exception {
		...
		String proofFileName = "proof_" + new File(abstractModelName).getName().replaceAll(AsmetaParserUtility.ASM_EXTENSION, "") + "_" + new File(refinedModelName).getName().replaceAll(AsmetaParserUtility.ASM_EXTENSION, "") + ".txt" ;
		if(saveProof) {
