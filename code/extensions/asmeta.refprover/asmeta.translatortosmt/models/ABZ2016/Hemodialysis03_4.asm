...
// RULE DEFINITIONS
	...
	macro rule r_rinse_test_tubes = //TO-DO
	...
	macro rule r_rinse_dialyzer =	//TO-DO
...
//PROPERTIES
//S-1	
CTLSPEC ag(connected_art_contr and connected_ven_contr) //THIS PROPERTIES IS FALSE - IT IS A CONTRADICTION
//S-5	
