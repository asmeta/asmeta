 ...
 * 
 */
class CNFExprConverterNaiveTest extends ExpressionsToTest {
	...
	// takes too long to compute, but it works
	@Disabled
	@Test void bigExpression() throws Exception {
