...
public class ConstantsCounter implements ExpressionVisitor<Integer> {

	static final public ConstantsCounter instance = new ConstantsCounter();

	@Override
	public Integer forIdExpression(IdExpression idExpression) {
		String idAsStr = idExpression.getIdString();
		if(idAsStr.equals(BoolType.TRUE_STR) || idAsStr.equals(BoolType.FALSE_STR)) {
			return 1;
		}
		return 0;
	}
