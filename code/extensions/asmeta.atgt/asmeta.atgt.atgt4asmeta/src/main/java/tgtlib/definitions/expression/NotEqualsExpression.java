...
/**
 * Not Equals expression. It is also used as xor among boolean operators?? To check
 * 
...
public class NotEqualsExpression extends CompareExpression {
	 ...
	 *            first != second
	 */
	public NotEqualsExpression(Expression firstOperand, Expression secondOperand) {
	...
	public <T> T accept(ExpressionVisitor<T> ask) {
		return ask.forNotEqualsExpression(this);
	}

	@Override
	public String toString() {
		return toString(Operator.NEQ);
