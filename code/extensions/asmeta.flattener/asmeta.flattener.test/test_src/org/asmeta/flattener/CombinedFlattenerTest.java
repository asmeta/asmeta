...
class CombinedFlattenerTest extends FlattenerTest {
	...
	void conwayGameOfLifeAgents() throws Exception {
		flattenerTest(examplesDir + "examples/conwayGameOfLife/gameOfLifeAgents.asm", false,MacroCallRuleFlattener.class, ForallRuleFlattener.class);
	...
	void forallRuleChoose() throws Exception {
		flattenerTest("./examples/forallRuleChoose.asm", false, MacroCallRuleFlattener.class, ForallRuleFlattener.class);
	}

	@Test
	void forallRuleChoose2() throws Exception {
		flattenerTest("./examples/forallRuleChoose.asm", false, RemoveNestingFlattener.class, ForallRuleFlattener.class);
	}

	@Test
	void forallRuleChoose3() throws Exception {
		//flattenerTest("./examples/forallRuleChoose.asm",ChooseRuleFlattener.class);
		flattenerTest("./examples/forallRuleChoose.asm", false, RemoveNestingFlattener.class, ForallRuleFlattener.class, ChooseRuleFlattener.class);
	}

	// I'm not sure it is expected to fail this one or it should pass
	@Test
	void forallRuleChoose4() throws Exception {
		assertThrows(AssertionError.class, () ->
			flattenerTest("./examples/forallRuleChoose.asm", false, ChooseRuleFlattener.class));
	}
	...
	void combinedRushHour() throws Exception {
		flattenerTest("../../../../asm_examples/examples/RushHour/RushHour.asm",
				...
				LetRuleFlattener.class, RemoveArgumentsFlattener.class
				);
	}

	@Test
	void forallChoose() throws Exception {
		flattenerTest("./examples/forallChooseRule.asm", false, ChooseRuleFlattener.class, ForallRuleFlattener.class);
	}

	@Test
	void testCase() throws Exception {
		flattenerTest("./examples/nestedIfCase.asm", false, CaseRuleFlattener.class, RemoveNestingFlattener.class);
	}
	...
	void coffeeVendingMachine() throws Exception {
		flattenerTest(examplesDir + "examples/coffeeVendingMachine/coffeeVendingMachine.asm",
				...
				ForallRuleFlattener.class, MacroCallRuleFlattener.class
				);
	}

	@Test
	void abstractDomain() throws Exception {
		flattenerTest("./examples/abstractDomain.asm", false, ALL_FLATTENERS);
	}

	@Test
	void chooseRule() throws Exception {
		flattenerTest("./examples/chooseRule.asm", false, ALL_FLATTENERS);
	}

	@Test
	void macroChooseRule() throws Exception {
		flattenerTest("./examples/macroRuleChoose.asm", false, ALL_FLATTENERS);
	}
	...
	void ticTacToe() throws Exception {
		flattenerTest(examplesDir + "examples/ticTacToe/ticTacToe_simulator.asm",
				...
				//ChooseRuleFlattener.class,
				LetRuleFlattener.class,
				RemoveArgumentsFlattener.class, CaseRuleFlattener.class);
	}
}
