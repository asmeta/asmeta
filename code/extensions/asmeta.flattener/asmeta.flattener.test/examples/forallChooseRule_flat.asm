...
definitions:
    ...
    function chooseVar0 = chooseone({$b89 in ConcrDom| lt($b89,2) : $b89})
    function chooseVar1 = chooseone({$b90 in ConcrDom| lt($b90,1) : $b90})
    function chooseVar2 = chooseone({$b91 in ConcrDom| lt($b91,3) : $b91})
    function chooseVar3 = chooseone({$b92 in ConcrDom| lt($b92,5) : $b92})
    function chooseVar4 = chooseone({$b93 in ConcrDom| lt($b93,4) : $b93})
