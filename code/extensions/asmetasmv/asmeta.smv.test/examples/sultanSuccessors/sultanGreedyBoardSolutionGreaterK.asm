asm sultanGreedyBoardSolutionGreaterK
...
definitions:
	...
	//Board 2: permette di ottenere una soluzione con valore maggiore di K
	...
	//Board 2
	//Si puo' ottenere una soluzione con 5 regine il cui valore sia maggiore di valoreK 
	CTLSPEC ef(regineInserite = nRegine and sommaValoriRegine >= valoreK)
	CTLSPEC ef(regineInserite = nRegine and sommaValoriRegine >= valoreK and ag(regineInserite = nRegine and sommaValoriRegine >= valoreK))
