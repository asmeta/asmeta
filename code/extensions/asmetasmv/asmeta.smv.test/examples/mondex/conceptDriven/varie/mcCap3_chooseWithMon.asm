...
//i choose sono sostituiti da funzioni monitorate

asm mcCap3_chooseWithMon
...
signature:
	...
	static paymentDetails: Prod(MessageType,Name,MoneyDomain,TidDomain) -> Prod(Name, MoneyDomain, TidDomain)

	dynamic monitored receiver: Name//per scegliere la carta da eseguire
