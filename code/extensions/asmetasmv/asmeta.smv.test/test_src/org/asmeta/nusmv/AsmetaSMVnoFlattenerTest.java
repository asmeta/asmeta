...
public class AsmetaSMVnoFlattenerTest extends AsmetaSMVtest {
	...
	public void dirTaxiTest() {
		testAllCtlPropsAreTrue("examples/taxi/main.asm", 12);
	}
	...
	@Test
	public void absTest() {
		testAllCtlPropsAreTrue("examples/abs.asm", 12);
	}

	@Test
	public void abstractTest() {
		testAllCtlPropsAreTrue("examples/abstract.asm", 2);
	}
	...
	public void agentsTest() {
		testAllCtlPropsAreTrue("examples/agents.asm", 7);
	}

	@Test
	public void agents1Test() {
		testAllCtlPropsAreTrue("examples/agents1.asm", 2);
	}
	...
	public void agentsChoose3Test() {
		testAllCtlPropsAreTrue("examples/agentsChoose3.asm", 11);
	}
	...
	public void agentsForallTest() {
		testAllCtlPropsAreTrue("examples/agentsForall.asm", 7);
	}
	...
	public void agentsForall3Test() {
		testAllCtlPropsAreTrue("examples/agentsForall3.asm", 3);
	}

	@Test
	public void bitCounterTest() {
		testAllCtlPropsAreTrue("examples/bitCounter.asm", 4);
	}

	@Test
	public void bitCounterAgentsTest() {
		testAllCtlPropsAreTrue("examples/bitCounterAgents.asm", 4);
	}

	@Test
	public void chooseTest() {
		testAllCtlPropsAreTrue("examples/choose.asm", 2);
	}

	@Test
	public void caseTermTest() {
		testAllCtlPropsAreTrue("examples/caseTerm.asm", 8);
	}

	@Test
	public void conditionalTermTest() {
		testAllCtlPropsAreTrue("examples/conditionalTerm.asm", 3);
	}
	...
	public void chooseMonTest() {
		testAllCtlPropsAreTrue("examples/chooseMon.asm", 8);
	}
	...
	public void chooseRule2Test() {
		testAllCtlPropsAreTrue("examples/chooseRule2.asm", 4);
	}

	@Test
	public void chooseRule3Test() {
		testAllCtlPropsAreTrue("examples/chooseRule3.asm", 8);
	}
	...
	public void derivedBehaviourTest() {
		testAllCtlPropsAreTrue("examples/derivedBehaviour.asm", 4);
	}

	@Test
	public void derivedCtlCheckTest() {
		testAllCtlPropsAreTrue("examples/derivedCtlCheck.asm", 14);
	}
	...
	public void derivedExhaustiveTest() {
		testAllCtlPropsAreTrue("examples/derivedExhaustive.asm", 2);
	}
	...
	public void ferryman_v2Test() {
		testAllCtlPropsAreTrue("examples/ferryman_v2.asm", 7);
	}
	...
	public void Tictactoe_v2Test() {
		testAllCtlPropsAreTrue("examples/Tictactoe_v2.asm", 7);
	}
	...
	public void updateVC() {
		testAllCtlPropsAreTrue("examples/coffeeVendingMachineNC.asm", 1);
	}

	@Test
	public void trainTest() {
		testAllCtlPropsAreTrue("telecamere/trainTrack.asm", 1);
	}

	@Test
	public void pillBoxTest() {
		testAllCtlPropsAreTrue("F:\\Dati-Andrea\\GitHub\\quasmed\\PillboxASM\\pillbox_for_PropertyVerification.asm", 1);
	}

	@Test
	public void pillBoxTestAG() {
		testAllCtlPropsAreTrue("C:\\Users\\garganti\\Dropbox\\Documenti\\progetti\\quasmed_git\\PillboxASM\\pillbox_for_PropertyVerification.asm", 1);
	}
	
	@Test
	public void armadioTest() {
		testAllCtlPropsAreFalse("examples\\tvsw_angelo\\ArmadioCaramelle2.asm", 1);
	}

	@Test
	public void armadioTest2() {
		testAllCtlPropsAreFalse("examples\\tvsw_angelo\\ArmadioCaramelle3.asm", 1);
	}
