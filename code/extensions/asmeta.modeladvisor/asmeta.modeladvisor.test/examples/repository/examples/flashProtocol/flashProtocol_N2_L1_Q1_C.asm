...
//nella main rule a1 e a2 sono selezionate con la choose rule
//ee in parallelo
...
default init s0:
	...
	function curPhase($a in AgentDomain, $l in Line) = at({(a1, l1) -> READY, (a2, l1) -> READY}, ($a, $l))
	function ccState($a in AgentDomain, $l in Line) = at({(a1, l1) -> INVALID, (a2,l1) -> INVALID}, ($a, $l))
	function pending($l in Line) = at({l1 -> false}, $l)
	function sharer($l in Line, $a in AgentDomain) = at({(l1, a1) -> false, (l1, a2) -> false}, ($l, $a))
