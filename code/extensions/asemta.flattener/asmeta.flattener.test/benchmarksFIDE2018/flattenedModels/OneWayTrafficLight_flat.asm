...
definitions:
    ...
    main rule r_Main =
        par
            if and(and(and(eq(phase,STOP1STOP2),eq(timer(STOP1STOP2),120)),passed(120)),and(true,eq(lightUnit2,lightUnit1))) then
            ...
            if and(and(and(eq(phase,GO1STOP2),eq(timer(GO1STOP2),50)),passed(50)),and(true,eq(lightUnit1,lightUnit2))) then
            ...
            if and(and(and(eq(phase,STOP2STOP1),eq(timer(STOP2STOP1),50)),passed(50)),and(true,eq(lightUnit1,lightUnit2))) then
                stopLight(lightUnit1) := not(stopLight(lightUnit2))
            endif
            ...
            if and(and(and(eq(phase,STOP2STOP1),eq(timer(STOP2STOP1),120)),passed(120)),and(true,eq(lightUnit1,lightUnit2))) then
            ...
            if and(and(and(eq(phase,STOP1STOP2),eq(timer(STOP1STOP2),50)),passed(50)),and(true,eq(lightUnit2,lightUnit1))) then
            ...
            if and(and(and(eq(phase,GO1STOP2),eq(timer(GO1STOP2),120)),passed(120)),and(true,eq(lightUnit1,lightUnit2))) then
                stopLight(lightUnit1) := not(stopLight(lightUnit2))
            endif
            if and(and(and(eq(phase,STOP1STOP2),eq(timer(STOP1STOP2),120)),passed(120)),eq(lightUnit2,lightUnit1)) then
                goLight(lightUnit1) := not(goLight(lightUnit2))
            ...
            if and(and(and(eq(phase,GO2STOP1),eq(timer(GO2STOP1),120)),passed(120)),and(true,eq(lightUnit2,lightUnit1))) then
                stopLight(lightUnit2) := not(stopLight(lightUnit1))
            endif
            if and(and(and(eq(phase,GO2STOP1),eq(timer(GO2STOP1),50)),passed(50)),and(eq(lightUnit2,lightUnit1),eq(lightUnit2,lightUnit1))) then
                stopLight(lightUnit1) := not(stopLight(lightUnit1))
            ...
            if and(and(and(eq(phase,GO2STOP1),eq(timer(GO2STOP1),50)),passed(50)),and(true,eq(lightUnit2,lightUnit1))) then
                stopLight(lightUnit2) := not(stopLight(lightUnit1))
            endif
            if and(and(and(eq(phase,GO1STOP2),eq(timer(GO1STOP2),120)),passed(120)),and(true,eq(lightUnit1,lightUnit2))) then
                goLight(lightUnit1) := not(goLight(lightUnit2))
