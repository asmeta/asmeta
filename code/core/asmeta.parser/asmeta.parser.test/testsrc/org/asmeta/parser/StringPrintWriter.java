...
public class StringPrintWriter extends PrintWriter {
	...
	/**
	 * <p>
	 * Since toString() returns information *about* this object, we want a separate
	 * method to extract just the contents of the internal buffer as a String.
	 * </p>
	 *
	...
	/// return if it is closed or not usable anymore
