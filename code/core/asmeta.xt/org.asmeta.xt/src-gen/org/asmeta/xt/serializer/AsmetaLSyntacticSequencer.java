...
public class AsmetaLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_CtlSpec_CTLSPECKeyword_0_0_or_CtlspecKeyword_0_1;
	...
	protected AbstractElementAlias match_LtlSpec_LTLSPECKeyword_0_0_or_LtlspecKeyword_0_1;
	...
	protected void init(IGrammarAccess access) {
		...
		match_CtlSpec_CTLSPECKeyword_0_0_or_CtlspecKeyword_0_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getCtlSpecAccess().getCTLSPECKeyword_0_0()), new TokenAlias(false, false, grammarAccess.getCtlSpecAccess().getCtlspecKeyword_0_1()));
		...
		match_LtlSpec_LTLSPECKeyword_0_0_or_LtlspecKeyword_0_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getLtlSpecAccess().getLTLSPECKeyword_0_0()), new TokenAlias(false, false, grammarAccess.getLtlSpecAccess().getLtlspecKeyword_0_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_CtlSpec_CTLSPECKeyword_0_0_or_CtlspecKeyword_0_1.equals(syntax))
				emit_CtlSpec_CTLSPECKeyword_0_0_or_CtlspecKeyword_0_1(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_LtlSpec_LTLSPECKeyword_0_0_or_LtlspecKeyword_0_1.equals(syntax))
				emit_LtlSpec_LTLSPECKeyword_0_0_or_LtlspecKeyword_0_1(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 * </pre>
	 */
	protected void emit_CtlSpec_CTLSPECKeyword_0_0_or_CtlspecKeyword_0_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     constrainedDomain=StandardDomain (ambiguity) (rule end)
	 ...
	 * </pre>
	 */
	protected void emit_LtlSpec_LTLSPECKeyword_0_0_or_LtlspecKeyword_0_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
