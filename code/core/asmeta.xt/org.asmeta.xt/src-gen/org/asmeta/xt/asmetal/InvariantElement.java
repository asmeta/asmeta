 ...
 *   <li>{@link org.asmeta.xt.asmetal.InvariantElement#getConstrainedDomain <em>Constrained Domain</em>}</li>
...
public interface InvariantElement extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Constrained Domain</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Constrained Domain</em>' containment reference.
   * @see #setConstrainedDomain(StandardDomain)
   * @see org.asmeta.xt.asmetal.AsmetalPackage#getInvariantElement_ConstrainedDomain()
   * @model containment="true"
   * @generated
   */
  StandardDomain getConstrainedDomain();

  /**
   * Sets the value of the '{@link org.asmeta.xt.asmetal.InvariantElement#getConstrainedDomain <em>Constrained Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Constrained Domain</em>' containment reference.
   * @see #getConstrainedDomain()
   * @generated
   */
  void setConstrainedDomain(StandardDomain value);
