 ...
 *   <li>{@link org.asmeta.xt.asmetal.impl.InvariantElementImpl#getConstrainedDomain <em>Constrained Domain</em>}</li>
...
public class InvariantElementImpl extends MinimalEObjectImpl.Container implements InvariantElement
{
  ...
  /**
   * The cached value of the '{@link #getConstrainedDomain() <em>Constrained Domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected StandardDomain constrainedDomain;
   ...
   */
  @Override
  public StandardDomain getConstrainedDomain()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetConstrainedDomain(StandardDomain newConstrainedDomain, NotificationChain msgs)
  {
    StandardDomain oldConstrainedDomain = constrainedDomain;
    constrainedDomain = newConstrainedDomain;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN, oldConstrainedDomain, newConstrainedDomain);
   ...
   */
  @Override
  public void setConstrainedDomain(StandardDomain newConstrainedDomain)
  {
    if (newConstrainedDomain != constrainedDomain)
    {
      NotificationChain msgs = null;
      if (constrainedDomain != null)
        msgs = ((InternalEObject)constrainedDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN, null, msgs);
      if (newConstrainedDomain != null)
        msgs = ((InternalEObject)newConstrainedDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN, null, msgs);
      msgs = basicSetConstrainedDomain(newConstrainedDomain, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN, newConstrainedDomain, newConstrainedDomain));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN:
        return basicSetConstrainedDomain(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_NAME:
        ...
        return;
      case AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN:
        setConstrainedDomain((StandardDomain)newValue);
        return;
      case AsmetalPackage.INVARIANT_ELEMENT__DOMAIN_LIST:
        getDomainList().clear();
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_NAME:
        ...
        return;
      case AsmetalPackage.INVARIANT_ELEMENT__CONSTRAINED_DOMAIN:
        setConstrainedDomain((StandardDomain)null);
        return;
      case AsmetalPackage.INVARIANT_ELEMENT__DOMAIN_LIST:
        getDomainList().clear();
        return;
