...
public class StandardLibraryHardCoded {
	public final static String StandardLibrary = """
			...
			/*----------- Basic Functions on Sets--------------*/
				...
				//static count: Prod(Powerset(D),D) -> Natural // PA 18/12/2010 Maybe not needed on sets. An element either belong or not belong to a set. contains should be enough.\s
	...
	public final static String CTLLibrary = """
			module CTLLibrary
	...
	public final static String LTLlibrary = """
			module LTLlibrary
