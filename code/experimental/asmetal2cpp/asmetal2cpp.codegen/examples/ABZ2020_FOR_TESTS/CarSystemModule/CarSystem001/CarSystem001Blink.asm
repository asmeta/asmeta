...
signature:
	...
	static pitman5Deflection: PitmanArmUpDown -> Boolean //True if pitman is 5� deflection (UPWARD5 or DOWNWARD5)
	static pitman5LongDeflection: PitmanArmUpDown -> Boolean //True if pitman is 5� long deflection (UPWARD5_LONG or DOWNWARD5_LONG)
	static pitman7Deflection: PitmanArmUpDown -> Boolean //True if pitman is 7� deflection (UPWARD7 or DOWNWARD7)
