...
public class HeaderGenerator extends AsmToCGenerator {
  ...
  public String compileAsm(final Asm asm) {
    ...
    _builder_2.append("�copyright�");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("// �asmName�.h automatically generated from ASMETA2CODE");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("#ifndef �asmName.toUpperCase�_H");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("#define �asmName.toUpperCase�_H");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.newLine();
    _builder_2.append("\t");
    ...
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�includeLibrary(asm)�");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.newLine();
    _builder_2.append("\t");
    ...
    _builder_2.newLine();
    _builder_2.append("namespace �asmName�namespace{");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�domainSignature(asm)� //devo togliere questo in Timer perch� non serve");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("}");
    _builder_2.newLine();
    ...
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("using namespace �asmName�namespace;");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�abstractClassDef(asm)� //devo togliere questo in Timer perch� non serve");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("class �asmName� �addExtension(asm)�{");
    _builder_2.newLine();
    _builder_2.append("\t  ");
    _builder_2.newLine();
    _builder_2.append("\t");
    ...
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�domainContainer(asm)�");
    _builder_2.newLine();
    _builder_2.append("\t");
    ...
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�functionSignature(asm)�");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("/* RULE DEFINITION */");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.append("�ruleDefinition(asm)�");
    _builder_2.newLine();
    _builder_2.append("\t");
    _builder_2.newLine();
    _builder_2.append("\t");
  ...
  protected String foo(final RuleDeclaration r, final String methodName, final Asm asm) {
    ...
    if (_equals) {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("void �methodName�();");
      _builder.newLine();
      return _builder.toString();
    } else {
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("void �methodName� (�new Util().adaptRuleParam(r.variable, asm).replaceAll(\"\\\\$\",\"_\")�);");
      _builder_1.newLine();
