		...
		endpar
	 	...
	 	if pillTakenWithDelay($compartment) then
			...
			forall $c2 in next($compartment) do 
			   if	(((iton(at(time_consumption($c2),drugIndex($c2)) - (systemTime mod 1440n)) //it should be actual_time_consumption, but since it is updated in the next state I use pillboxSystemTime here
