...
public class Util {
	...
	public static String parsename(String s) {
		if (s.equals("and")) {
			...
			throw new RuntimeException("The function " + s + " is not supported");
		}
		else {
			return s;
		}
	...
	public static void checkTypeDomain(ConcreteDomain concrDom) {
		...
		if (!Util.allowedTypeDomain(typeDom)) {
			throw new RuntimeException("The type domain of "
...
//SILVIA	
	 ...
	 *             the asm not supported exception
	 */
	public static void checkRuleDomain(String domainName){
		if (Util.notAllowedTypeDomain(domainName)){
			throw new RuntimeException("The type domain of cannot be " + domainName + ". Only finite domains are allowed.");
		}
	}
	 ...
	 *             the asm not supported exception
	 */
	public static void checkDomain(Domain domain) {
		if (!allowedDomain(domain)) {
			throw new RuntimeException("Il dominio " + domain.getName()
	...
	public static void checkLocationName(String locationName) {
		if (locationName.equals("eg") || locationName.equals("ex")
			...
			throw new RuntimeException("\"" + locationName
	...
	static void checkUpdate(Map<String, Map<String, String>> updateMap,
		...
		if (!isConsistentUpdate(updateMap, location, cond, value)) {
			throw new RuntimeException("Update inconsistente della "
