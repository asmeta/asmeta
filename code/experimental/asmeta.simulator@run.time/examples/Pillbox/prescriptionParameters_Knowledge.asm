...
signature:
	...
	derived minToInterferer: Prod(Medicine,Medicine) -> Natural //indicates the minimum separation (in terms of hours) from the medicine M to the interferer N
	//derived minFrInterferer: Prod(Medicine,Medicine) -> Natural //minimum separation (in terms of hours) from the interferer N to the medicine M
