...
public class CompositionTest {
	...
	public void testMVM() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		BiPipeHalfDup asm2 = new BiPipeHalfDup(new LeafAsm(path2 + "MVMcontroller04.asm"), new LeafAsm(path2 + "supervisor03.asm"));
	...
	public void testParsePipeN() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat(path+"asmC.asm").concat(" | ").concat(path+"asmS.asm").concat(" | ").concat(path+"asmH.asm").concat(" )");
	...
	public void testParseFullDupBis() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat(path+"asmC.asm").concat(" <||> ").concat("( ").concat(path+"asmS.asm").concat(" <||> ").concat(path+"asmH.asm").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParseDuplex2() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmS.asm").concat(" <||> ").concat(path+"asmH.asm").concat(" )").concat(" <|> ").concat(path+"asmC.asm").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParseParN2() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat(path+"asmS.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmS.asm").concat(" )");
	...
	public void testParseParN3() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" || ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" )");
		//concat(" || ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParseParN4() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" || ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParse1Bis() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" <||> ").concat(path+"asmS.asm").concat(" )").concat(" | ").concat(path+"asmH.asm").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParse3() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat(path+"asmC.asm").concat(" | ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" | ").concat(path+"asmH.asm").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	@Test//( ( asmC || asmS || asmH ) | ( asmC || asmS || asmH ) | ( asmC || asmS || asmH ) )
		 //ok
	public void testParse6() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" | ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" | ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	@Test//( ( asmC || asmS || asmH ) | ( asmS || asmC || asmH ) <|> ( asmC || asmH || asmS ) )
		 //senza parentesi, pipe attraversata anche al ritorno (riguarda)
	public void testParse8() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" | ").concat("( ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" <|> ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmH.asm").concat(" || ").concat(path+"asmS.asm").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
	...
	public void testParse8Bis() throws Exception {
		Logger.getLogger(Simulator.class).setLevel(Level.DEBUG);
		String a="( ".concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" | ").concat("( ").concat("( ").concat(path+"asmS.asm").concat(" || ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmH.asm").concat(" )").concat(" <|> ").concat("( ").concat(path+"asmC.asm").concat(" || ").concat(path+"asmH.asm").concat(" || ").concat(path+"asmS.asm").concat(" )").concat(" )").concat(" )");
		System.out.println(a);
		Parser asm=new Parser(a);
		Composition asmI = asm.toComposition();
		asmI.eval();		
