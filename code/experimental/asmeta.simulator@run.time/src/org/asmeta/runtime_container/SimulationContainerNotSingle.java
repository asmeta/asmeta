 ...
 */
public class SimulationContainerNotSingle extends SimulationContainer implements IModelExecution, IModelAdaptation {
	 ...
	 */
	/*public static SimulationContainerNotSingle getInstance() {
		if (instance == null)
			instance = new SimulationContainerNotSingle();
		return instance;
	}*/
