				...
				try {
					...
					if(table.getSelectedColumn() == 0) {
						if(selectedData.trim().equals("<No name>".trim())) 
							new Edit("","NAME",selected_invariant).setVisible(true);
						else 
							new Edit(selectedData,"NAME",selected_invariant).setVisible(true);
					}
					else if(table.getSelectedColumn() == 1) 
						new Edit(selectedData,"OVER",selected_invariant).setVisible(true);
					else 
						new Edit(selectedData,"CONTENT",selected_invariant).setVisible(true);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
