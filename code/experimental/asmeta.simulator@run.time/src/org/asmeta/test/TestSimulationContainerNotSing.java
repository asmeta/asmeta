...
import org.asmeta.runtime_container.SimulationContainerNotSingle;
 ...
 * The Class Test1.
 */
public class TestSimulationContainerNotSing {
...
//===================================START OF STARTEXE=============================================
	...
	public void StartExec1() throws Exception {
		...
		String model = "examples/Lavatrice.asm";
		SimulationContainerNotSingle i = new SimulationContainerNotSingle();
		i.init(3);
...
//===================================START RUN WITH MONITORING=============================================
		...
		public void run1() throws Exception {
			...
			String model = "examples/Lavatrice.asm";
			SimulationContainerNotSingle imp = new SimulationContainerNotSingle();
			imp.init(3);
			Map<String, String> monitored = new HashMap<String, String>();
			int id = imp.startExecution(model);
			monitored.put("operation", "ALLUMER"); 
