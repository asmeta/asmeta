...
import org.asmeta.nusmv.SeqRuleVisitor;
...
public class Environment {
	...
	boolean inSeqRule;
	boolean inMainRule;//we need to memorise when we are in the main rule. Why???? 
	 ...
	 * We can use it to replace occurrences of derived/static locations with their definitions.
	 */
	...
	/**
	 * It adds to the map "varValues" the variables "vars" with the corresponding values "values". 
	 * 
	...
	public boolean isInMainRule() {
		return inMainRule;
	}

	public void setInMainRule(boolean inMainRule) {
		this.inMainRule = inMainRule;
	}
