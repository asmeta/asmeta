...
public class GeneratorCompilerTest {
	...
	*/
	 ...
	 *
	 //Classe vuota
     @Test
     public void testBare() throws IOException, Exception { 
         String asmspec = "examples/Bare/Bare.asm";
         if (!test(asmspec, options).success) fail(); 
     }
	 * 
	 * 
	...
	*/
	...
	//Classe vuota
	@Test
	public void testLIFT() throws IOException, Exception {
		String asmspec = "examples/LIFT.asm";
		if (!test(asmspec, options).success)
			fail();
	}
	...
	//Classe vuota
	@Test
	public void testCashPoint() throws IOException, Exception {
		String asmspec = "examples/CashPoint.asm";
		if (!test(asmspec, options).success)
			fail();
	}
	*/
