...
public class DomainToJavaSigDef extends ReflectiveVisitor<String> {
    ...
    switch (_size) {
      case 2:
        ...
        for (int i = 0; (i < object.getDomains().size()); i++) {
          ...
          String _visit = new DomainToJavaString(this.res).visit(object.getDomains().get(i));
  ...
  public String visit(final SequenceDomain object) {
    ...
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("<");
    String _visit = new DomainToJavaString(this.res).visit(object.getDomain());
  ...
  public String visit(final PowersetDomain object) {
    ...
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("<");
    String _visit = new DomainToJavaString(this.res).visit(object.getBaseDomain());
    _builder.append(_visit);
    _builder.append("> ");
    sb.append(_builder);
    return sb.toString();
  ...
  public String visit(final MapDomain object) {
    ...
    sb.append(_builder);
    StringConcatenation _builder_1 = new StringConcatenation();
    String _visit = new DomainToJavaString(this.res).visit(object.getSourceDomain());
    _builder_1.append(_visit);
    _builder_1.append(",");
    sb.append(_builder_1);
    StringConcatenation _builder_2 = new StringConcatenation();
    String _visit_1 = new DomainToJavaString(this.res).visit(object.getTargetDomain());
  ...
  public String visit(final EnumTd object) {
    ...
    for (int i = 0; (i < object.getElement().size()); i++) {
      ...
      if (_notEquals) {
        StringConcatenation _builder_1 = new StringConcatenation();
        String _visit = new DomainToJavaString(this.res).visit(object.getElement().get(i));
        _builder_1.append(_visit);
        _builder_1.append(", ");
        sb.append(_builder_1);
      } else {
        StringConcatenation _builder_2 = new StringConcatenation();
        String _visit_1 = new DomainToJavaString(this.res).visit(object.getElement().get(i));
        _builder_2.append(_visit_1);
        _builder_2.append("}");
  ...
  public String visit(final ConcreteDomain object) {
    ...
    if ((_isDynamic).booleanValue()) {
      ...
      _builder.newLine();
      _builder.append("List<");
      String _visit = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      _builder.append(_visit);
      _builder.append("> elems = new ArrayList<>();\t\t\t      ");
      _builder.newLineIfNotEmpty();
      String _visit_1 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      ...
      _builder.append(_name_1);
      _builder.append("(");
      String _visit_2 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      ...
      _builder.append("   ");
      _builder.append("List<");
      String _visit_3 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      ...
      String _visit_4 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      _builder_1.append(_visit_4, "\t\t\t\t");
      _builder_1.append("> elems = new ArrayList<>();");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append("                ");
      String _visit_5 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      ...
      String _visit_6 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
      ...
      _builder_1.append("\t\t\t\t");
      _builder_1.append("List<");
      String _visit_7 = new DomainToJavaString(this.res).visit(object.getTypeDomain());
