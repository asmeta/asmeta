    ...
    if (((object.getCodomain() instanceof SequenceDomain) || (object.getDomain() instanceof SequenceDomain))) {
      ...
      if (_tripleNotEquals) {
        ...
        if ((_codomain instanceof AbstractTd)) {
          ...
          if (_equals) {
            ...
            if ((_body instanceof CaseTerm)) {
              ...
              String _visit_4 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getVariable().get(this.i));
              _builder_2.append(_visit_4);
              _builder_2.append(",new Function<Void,");
              String _visit_5 = new ToString(this.asm).visit(object.getCodomain());
              _builder_2.append(_visit_5);
              ...
              _builder_2.append(",new Function<Void,");
              String _visit_9 = new ToString(this.asm).visit(object.getCodomain());
              ...
              _builder_3.append(",");
              String _visit_17 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getBody());
              ...
              String _visit_18 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getVariable().get(this.i));
          ...
          if (((this.controllo(object.getCodomain().getName())).booleanValue() || (object.getCodomain() instanceof EnumTd))) {
            if (((object.getDomain() instanceof ConcreteDomain) && (this.controllo(object.getCodomain().getName())).booleanValue())) {
              ...
              _builder_5.append(_visit_22);
              _builder_5.append(" a ");
              String _visit_23 = new TermToJavaConditionalAbs(this.asm).visit(object.getInitialization().get(0).getBody());
              ...
              String _visit_24 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getVariable().get(this.i));
            ...
            String _visit_26 = new ToString(this.asm).visit(object.getCodomain());
            _builder_6.append(_visit_26);
            ...
            String _visit_28 = new TermToJavaConditionalAbs(this.asm).visit(object.getInitialization().get(0).getBody());
            ...
            if ((_domain_1 instanceof ProductDomain)) {
              ...
              for (int i = 0; (i < object.getInitialization().get(0).getVariable().size()); i++) {
                ...
                if (_notEquals) {
                  ...
                  String _visit_29 = new ToString(this.asm).visit(object.getInitialization().get(0).getVariable().get(i).getDomain());
                  _builder_17.append(_visit_29);
                  _builder_17.append(",");
              ...
              String _visit_29 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getVariable().get(this.i));
              _builder_18.append(_visit_29);
        ...
        if (((this.controllo(object.getCodomain().getName())).booleanValue() || (object.getCodomain() instanceof EnumTd))) {
          ...
          String _visit_31 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getBody());
          _builder_19.append(_visit_31);
          _builder_19.append(";");
