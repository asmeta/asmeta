        ...
        if ((_codomain instanceof AbstractTd)) {
          ...
          if (((this.controllo(object.getCodomain().getName())).booleanValue() || (object.getCodomain() instanceof EnumTd))) {
            if (((object.getDomain() instanceof ConcreteDomain) && (this.controllo(object.getCodomain().getName())).booleanValue())) {
              ...
              _builder_6.append(" a ");
              String _visit_25 = new TermToJavaConditionalAbs(this.asm).visit(object.getInitialization().get(0).getBody());
              _builder_6.append(_visit_25);
              _builder_6.append(";");
            ...
            _builder_7.append(_visit_28);
            _builder_7.append(" a = new ");
            String _visit_29 = new ToString(this.asm).visit(object.getCodomain());
            _builder_7.append(_visit_29);
            _builder_7.append("();");
            ...
            String _visit_30 = new TermToJavaConditionalAbs(this.asm).visit(object.getInitialization().get(0).getBody());
            _builder_7.append(_visit_30, "\t\t\t           ");
            _builder_7.append(";");
            _builder_7.newLineIfNotEmpty();
            ...
            if ((_domain_2 instanceof ProductDomain)) {
              ...
              for (int i = 0; (i < object.getInitialization().get(0).getVariable().size()); i++) {
                ...
                if (_notEquals) {
                  ...
                  String _visit_32 = new ToString(this.asm).visit(object.getInitialization().get(0).getVariable().get(i).getDomain());
              ...
              String _visit_32 = new TermToJava(this.asm).visit(object.getInitialization().get(0).getVariable().get(this.i));
              _builder_19.append(_visit_32);
              _builder_19.append(",a);");
              _builder_19.newLineIfNotEmpty();
              sb.append(_builder_19);
