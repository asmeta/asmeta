...
public class QuickSort_Win {
	QuickSort esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QuickSort_Win window = new QuickSort_Win();
	 ...
	 */
	public QuickSort_Win() {
		esecuzione = new QuickSort();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("QuickSort ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("f");
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_1.setText(esecuzione.f.get().toString());
