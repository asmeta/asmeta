...
public class Parallelismo_Win {
	Parallelismo esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Parallelismo_Win window = new Parallelismo_Win();
	 ...
	 */
	public Parallelismo_Win() {
		esecuzione = new Parallelismo();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("Parallelismo ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("x");
		...
		JLabel VariabileControlled_Text_2 = new JLabel("y");
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_1.setText(esecuzione.x.get().toString());
				} catch (NullPointerException errC1) {
					VariabileControlled_Valore_1.setText("null");
				}
				try {
					VariabileControlled_Valore_2.setText(esecuzione.y.get().toString());
