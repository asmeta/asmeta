...
public class MapDomain_Win {

	MapDomain esecuzione;
	int stato = 0;
	JFrame frame;
...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							MapDomain_Win window = new MapDomain_Win();
	 ...
	 */
public MapDomain_Win() {

		esecuzione = new MapDomain();
		initialize();
	}
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("MapDomain ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("voti");
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.voti.get().toString());
