...
public class Ascensore_Win {

    Ascensore esecuzione;
    int stato = 0;
    JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ascensore_Win window = new Ascensore_Win();
	 ...
	 */
	public Ascensore_Win() {
		
		esecuzione = new Ascensore();
		initialize();
	}
	...
	private void initialize() {
		    ...
		    frame = new JFrame();
			//Titolo 
			frame.setTitle("Ascensore ASM -> Java");
			...
			JLabel VariabileControlled_Text_1 = new JLabel("statoPiano");
			...
			JLabel VariabileControlled_Text_2 = new JLabel("statoPorta");
			...
			JLabel VariabileMonitored_text_1 = new JLabel("signalPorta");
			...
			VariabileMonitored_Valore_1.setColumns(10);
					...
					try {
					VariabileMonitored_Valore_1.setText(esecuzione.signalPorta.Value.toString());
					}
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
				VariabileControlled_Valore_1.setText(esecuzione.statoPiano.oldValue.name());
				...
				try{
				VariabileControlled_Valore_2.setText(esecuzione.statoPorta.oldValue.name());
				...
				//"traduzione" della funzione askMonitored(esecuzione) del file _Exe
				   ...
				   esecuzione.signalPorta.Value = true;
				   else
				   	esecuzione.signalPorta.Value = false;
