...
public class battleship_Win {

    battleship esecuzione;
    int stato = 0;
    JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					battleship_Win window = new battleship_Win();
	 ...
	 */
	public battleship_Win() {
		
		esecuzione = new battleship();
		initialize();
	}
	...
	private void initialize() {
		    ...
		    frame = new JFrame();
			//Titolo 
			frame.setTitle("battleship ASM -> Java");
			...
			JLabel VariabileControlled_Text_1 = new JLabel("turnPlayerA");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
				VariabileControlled_Valore_1.setText(esecuzione.turnPlayerA.oldValue.name());
