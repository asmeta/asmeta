...
public class euclideMCD_Win {
	euclideMCD esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					euclideMCD_Win window = new euclideMCD_Win();
	 ...
	 */
	public euclideMCD_Win() {
		esecuzione = new euclideMCD();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("euclideMCD ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("numA");
		...
		JLabel VariabileControlled_Text_2 = new JLabel("numB");
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_1.setText(esecuzione.numA.get().toString());
				} catch (NullPointerException errC1) {
					VariabileControlled_Valore_1.setText("null");
				}
				try {
					VariabileControlled_Valore_2.setText(esecuzione.numB.get().toString());
