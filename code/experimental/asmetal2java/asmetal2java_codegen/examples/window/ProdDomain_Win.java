...
public class ProdDomain_Win {

	ProdDomain esecuzione;
	int stato = 0;
	JFrame frame;
...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							ProdDomain_Win window = new ProdDomain_Win();
	 ...
	 */
public ProdDomain_Win() {

		esecuzione = new ProdDomain();
		initialize();
	}
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("ProdDomain ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("number");
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.number.get().toString());
