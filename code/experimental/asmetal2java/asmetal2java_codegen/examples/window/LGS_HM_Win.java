...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							LGS_HM_Win window = new LGS_HM_Win();
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("LGS_HM ASM -> Java");
		...
		JLabel VariabileControlled_Text_8 = new JLabel("anomaly");
		...
		JLabel VariabileMonitored_text_2 = new JLabel("timeout");
		...
		try {
			VariabileMonitored_Valore_2.setText(esecuzione.timeout.Value.toString());
		}
		catch (NullPointerException errM1)
		{
		...
		JLabel VariabileMonitored_text_3 = new JLabel("gearsExtended");
		...
		JLabel VariabileMonitored_text_4 = new JLabel("gearsRetracted");
		...
		JLabel VariabileMonitored_text_5 = new JLabel("doorsClosed");
		...
		JLabel VariabileMonitored_text_6 = new JLabel("doorsOpen");
		...
		JLabel VariabileMonitored_text_7 = new JLabel("gearsShockAbsorber");
		...
		VariabileMonitored_Valore_7.setEditable(false);
		VariabileMonitored_Valore_7.setColumns(10);

		JLabel VariabileMonitored_text_7_1 = new JLabel(esecuzione.LandingSet_lista.get(0).toString());
		VariabileMonitored_text_7_1.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_text_7_1);

		JTextField VariabileMonitored_Valore_7_1 = new JTextField();
		VariabileMonitored_Valore_7_1.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_Valore_7_1);
		VariabileMonitored_Valore_7_1.setColumns(10);

		try {
			VariabileMonitored_Valore_7_1.setText("Insert Boolean");
		}
		catch (NullPointerException errM1)
		{
			VariabileMonitored_Valore_7_1.setText("Insert Boolean");
		...
		JLabel VariabileMonitored_text_7_2 = new JLabel(esecuzione.LandingSet_lista.get(1).toString());
		VariabileMonitored_text_7_2.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_text_7_2);

		JTextField VariabileMonitored_Valore_7_2 = new JTextField();
		VariabileMonitored_Valore_7_2.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_Valore_7_2);
		VariabileMonitored_Valore_7_2.setColumns(10);

		try {
			VariabileMonitored_Valore_7_2.setText("Insert Boolean");
		}
		catch (NullPointerException errM1)
		{
			VariabileMonitored_Valore_7_2.setText("Insert Boolean");
		...
		JLabel VariabileMonitored_text_7_3 = new JLabel(esecuzione.LandingSet_lista.get(2).toString());
		VariabileMonitored_text_7_3.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_text_7_3);

		JTextField VariabileMonitored_Valore_7_3 = new JTextField();
		VariabileMonitored_Valore_7_3.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_Valore_7_3);
		VariabileMonitored_Valore_7_3.setColumns(10);

		try {
			VariabileMonitored_Valore_7_3.setText("Insert Boolean");
		}
		catch (NullPointerException errM1)
		{
			VariabileMonitored_Valore_7_3.setText("Insert Boolean");
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_8.setText(esecuzione.anomaly.get().toString());
						...
						esecuzione.timeout.Value = true;
						else
						esecuzione.timeout.Value = false;

						if(VariabileMonitored_Valore_3_1.getText().contentEquals("true"))
						...
						if(VariabileMonitored_Valore_3_2.getText().contentEquals("true"))
						...
						if(VariabileMonitored_Valore_3_3.getText().contentEquals("true"))
