...
public class coffeeVendingMachine_Win {
	coffeeVendingMachine esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					coffeeVendingMachine_Win window = new coffeeVendingMachine_Win();
	 ...
	 */
	public coffeeVendingMachine_Win() {
		esecuzione = new coffeeVendingMachine();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("coffeeVendingMachine ASM -> Java");
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_2_1.setText(
							esecuzione.available.oldValues.get(esecuzione.Product_lista.get(0)).value.toString());
				} catch (NullPointerException errC02) {
					VariabileControlled_Text_2_1.setText("null");
				}
				try {
					VariabileControlled_Valore_2_2.setText(
							esecuzione.available.oldValues.get(esecuzione.Product_lista.get(1)).value.toString());
				} catch (NullPointerException errC02) {
					VariabileControlled_Text_2_1.setText("null");
				}
				try {
					VariabileControlled_Valore_2_3.setText(
							esecuzione.available.oldValues.get(esecuzione.Product_lista.get(2)).value.toString());
				} catch (NullPointerException errC02) {
					VariabileControlled_Text_2_1.setText("null");
				}
