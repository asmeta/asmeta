	...
	private void initialize() {
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					esecuzione.insertMoneySizeStandard_supporto.value = Integer
				...
				try {
					esecuzione.insertMoneySizeOther.Value = Integer
							.parseInt(VariabileMonitored_Valore_5.getText().toString());
				} catch (NumberFormatException err) {
