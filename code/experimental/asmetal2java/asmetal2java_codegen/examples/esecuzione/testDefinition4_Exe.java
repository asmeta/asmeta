// testDefinition4_Exe.java automatically generated from ASM2CODE
//Classe per l'esecuzione dei file java generati dalla traduzione di un programma ASM

import java.util.Scanner;

class testDefinition4_Exe {

	static void printControlled(testDefinition4 esecuzione) {
	...
	static void askMonitored(testDefinition4 esecuzione) {
...
public static void main(String[] args) {
		...
		System.out.println("INFO - file java creto e tradotto dal file originale testDefinition4.asm");
		System.out.println("Inizio esecuzione del file testDefinition4.java\n\n");

		testDefinition4 esecuzione = new testDefinition4();
