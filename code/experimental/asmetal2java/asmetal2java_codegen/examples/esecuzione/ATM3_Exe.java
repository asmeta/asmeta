	...
	static void askMonitored(ATM3 esecuzione) {
		...
		for(;;) {
			         int x;
			            ...
			            if (insertedPinControllo.isEmpty()) break;
			            try{
		...
		for(;;) {
			         int x;
			            ...
			            if (insertMoneySizeStandardControllo.isEmpty()) break;
			            try{
		...
		for(;;) {
			         int x;
			            ...
			            if (insertMoneySizeOtherControllo.isEmpty()) break;
			            try{
		...
		for(;;) {
			         int x;
			            ...
			            if (standardOrOtherControllo.isEmpty()) break;
			            try{
