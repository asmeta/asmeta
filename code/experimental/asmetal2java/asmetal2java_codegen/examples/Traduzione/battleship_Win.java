...
public class AbstractDom_Win {
	AbstractDom esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AbstractDom_Win window = new AbstractDom_Win();
	 ...
	 */
	public AbstractDom_Win() {
		esecuzione = new AbstractDom();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("AbstractDom ASM -> Java");
