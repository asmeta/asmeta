...
public class fattoriale_Win {

	fattoriale esecuzione;
	int stato = 0;
	JFrame frame;
...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							fattoriale_Win window = new fattoriale_Win();
	 ...
	 */
public fattoriale_Win() {

		esecuzione = new fattoriale();
		initialize();
	}
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("fattoriale ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("indice");
		...
		JLabel VariabileControlled_Text_2 = new JLabel("fattorialeparam");
		...
		JLabel VariabileMonitored_text_1 = new JLabel("valore");
		...
		try {
			VariabileMonitored_Valore_1.setText(esecuzione.valore.Value.toString());
		}
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.indice.get().toString());
						...
						try {
							VariabileControlled_Valore_2.setText(esecuzione.fattorialeparam.get().toString());
						...
						try
						{
							esecuzione.valore.Value = Integer.parseInt(VariabileMonitored_Valore_1.getText().toString());
						}
						catch ( NumberFormatException err)
						{
							esecuzione.valore.Value = 0;
						}
