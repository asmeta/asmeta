...
public class sluiceGateGround_Win {

	sluiceGateGround esecuzione;
	int stato = 0;
	JFrame frame;
...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							sluiceGateGround_Win window = new sluiceGateGround_Win();
	 ...
	 */
public sluiceGateGround_Win() {

		esecuzione = new sluiceGateGround();
		initialize();
	}
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("sluiceGateGround ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("phase");
		...
		JLabel VariabileMonitored_text_1 = new JLabel("passed");
		...
		VariabileMonitored_Valore_1.setEditable(false);
		VariabileMonitored_Valore_1.setColumns(10);

		JLabel VariabileMonitored_text_1_1 = new JLabel(esecuzione.Minutes_elems.get(0).toString());
		VariabileMonitored_text_1_1.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_text_1_1);

		JTextField VariabileMonitored_Valore_1_1 = new JTextField();
		VariabileMonitored_Valore_1_1.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_Valore_1_1);
		VariabileMonitored_Valore_1_1.setColumns(10);

		try {
			VariabileMonitored_Valore_1_1.setText("Insert Boolean");
		}
		...
		JLabel VariabileMonitored_text_1_2 = new JLabel(esecuzione.Minutes_elems.get(1).toString());
		VariabileMonitored_text_1_2.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_text_1_2);

		JTextField VariabileMonitored_Valore_1_2 = new JTextField();
		VariabileMonitored_Valore_1_2.setHorizontalAlignment(SwingConstants.CENTER);
		panel_sx.add(VariabileMonitored_Valore_1_2);
		VariabileMonitored_Valore_1_2.setColumns(10);

		try {
			VariabileMonitored_Valore_1_2.setText("Insert Boolean");
		}
		catch (NullPointerException errM1)
		{
			VariabileMonitored_Valore_1_2.setText("Insert Boolean");
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.phase.oldValue.name());
						...
						if(VariabileMonitored_Valore_1_1.getText().contentEquals("true"))
						esecuzione.passed.set(esecuzione.Minutes_elem,true);
						else
						esecuzione.passed.set(esecuzione.Minutes_elem,false);

						if(VariabileMonitored_Valore_1_2.getText().contentEquals("true"))
						esecuzione.passed.set(esecuzione.Minutes_elem,true);
						else
						esecuzione.passed.set(esecuzione.Minutes_elem,false);
