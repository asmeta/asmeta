...
public class AdvancedClock_Win {

    AdvancedClock esecuzione;
    int stato = 0;
    JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdvancedClock_Win window = new AdvancedClock_Win();
	 ...
	 */
	public AdvancedClock_Win() {
		
		esecuzione = new AdvancedClock();
		initialize();
	}
	...
	private void initialize() {
		    ...
		    frame = new JFrame();
			//Titolo 
			frame.setTitle("AdvancedClock ASM -> Java");
			...
			JLabel VariabileControlled_Text_1 = new JLabel("seconds");
			...
			JLabel VariabileControlled_Text_2 = new JLabel("minutes");
			...
			JLabel VariabileControlled_Text_3 = new JLabel("hours");
			...
			public void actionPerformed(ActionEvent e) {
				...
				VariabileControlled_Valore_1.setText(esecuzione.seconds.get().value.toString());
				...
				VariabileControlled_Valore_2.setText(esecuzione.minutes.get().value.toString());
				...
				VariabileControlled_Valore_3.setText(esecuzione.hours.get().value.toString());
