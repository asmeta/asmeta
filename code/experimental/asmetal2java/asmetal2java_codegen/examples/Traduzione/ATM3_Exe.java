...
class ATM3_Exe {
	...
	static void printControlled(ATM3 esecuzione) {
		...
		System.out.println(
				"numOfBalanceChecks = " + esecuzione.numOfBalanceChecks.get());
	...
	static void askMonitored(ATM3 esecuzione) {
		...
		System.out.print(
				"Inserire un valore Intero per insertedPin (Integer):  ");
		...
		System.out.print(
				"Inserire un numero per indicare l'enumerativo per selectedService "
		...
		System.out.print(
				"Inserire un valore Intero per insertMoneySizeStandard (Integer):  ");
		Scanner insertMoneySizeStandardinput = new Scanner(System.in);

		for (;;) {
			int x;
			String insertMoneySizeStandardControllo =
					insertMoneySizeStandardinput.nextLine();
			...
			esecuzione.insertMoneySizeStandard.set(
					esecuzione.insertMoneySizeStandard_supporto);
			break;
		}

		System.out.print(
				"Inserire un valore Intero per insertMoneySizeOther (Integer):  ");
		Scanner insertMoneySizeOtherinput = new Scanner(System.in);

		for (;;) {
			int x;
			String insertMoneySizeOtherControllo =
					insertMoneySizeOtherinput.nextLine();
		...
		System.out.print(
				"Inserire un numero per indicare l'enumerativo per standardOrOther "
		...
		for (;;) {
			...
			esecuzione.standardOrOther.set(
					esecuzione.MoneySizeSelection_lista.get(x - 1));
			break;
		}
