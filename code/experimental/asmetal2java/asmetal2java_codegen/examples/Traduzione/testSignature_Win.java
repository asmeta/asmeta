	...
	private void initialize() {
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_9_1
							.setText(esecuzione.funC6.oldValues.get(esecuzione.Color_lista.get(0)).value.toString());
				} catch (NullPointerException errC09) {
					VariabileControlled_Text_9_1.setText("null");
				}
				try {
					VariabileControlled_Valore_9_2
							.setText(esecuzione.funC6.oldValues.get(esecuzione.Color_lista.get(1)).value.toString());
				} catch (NullPointerException errC09) {
					VariabileControlled_Text_9_1.setText("null");
				}
				try {
					VariabileControlled_Valore_9_3
							.setText(esecuzione.funC6.oldValues.get(esecuzione.Color_lista.get(2)).value.toString());
				} catch (NullPointerException errC09) {
					VariabileControlled_Text_9_1.setText("null");
				}
				try {
				...
				try {
					esecuzione.funM3_supporto.value = Integer
							.parseInt(VariabileMonitored_Valore_4.getText().toString());
				} catch (NumberFormatException err) {
