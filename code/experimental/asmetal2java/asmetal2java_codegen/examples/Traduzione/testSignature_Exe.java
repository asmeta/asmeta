	...
	static void askMonitored(testSignature esecuzione) {
		...
		for(;;) {
			         int x;
			            ...
			            if (funM1Controllo.isEmpty()) break;
			            try{
		...
		for(;;) {
			         int x;
			            ...
			            if (funM3Controllo.isEmpty()) break;
			            try{
