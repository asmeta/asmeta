...
public class BasicDomain_Win {

    BasicDomain esecuzione;
    int stato = 0;
    JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BasicDomain_Win window = new BasicDomain_Win();
	 ...
	 */
	public BasicDomain_Win() {
		
		esecuzione = new BasicDomain();
		initialize();
	}
	...
	private void initialize() {
		    ...
		    frame = new JFrame();
			//Titolo 
			frame.setTitle("BasicDomain ASM -> Java");
