// AdvancedClock_Exe.java automatically generated from ASM2CODE
//Classe per l'esecuzione dei file java generati dalla traduzione di un programma ASM

import java.util.Scanner;

class AdvancedClock_Exe {

	static void printControlled(AdvancedClock esecuzione) {
	...
	static void askMonitored(AdvancedClock esecuzione) {

	}

public static void main(String[] args) {

		System.out.println("INFO - file java creto e tradotto dal file originale AdvancedClock.asm");
		System.out.println("Inizio esecuzione del file AdvancedClock.java\n\n");

		AdvancedClock esecuzione = new AdvancedClock();
