...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							moncontr_Win window = new moncontr_Win();
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("moncontr ASM -> Java");
		...
		JLabel VariabileControlled_Text_1 = new JLabel("controlledfunction");
		...
		JLabel VariabileControlled_Text_2 = new JLabel("controlledfunction2");
		...
		JLabel VariabileMonitored_text_1 = new JLabel("monitoredfunction");
		...
		try {
			VariabileMonitored_Valore_1.setText(esecuzione.monitoredfunction.Value.toString());
		}
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.controlledfunction.get().toString());
						...
						try {
							VariabileControlled_Valore_2.setText(esecuzione.controlledfunction2.get().toString());
						...
						try
						{
							esecuzione.monitoredfunction.Value = Integer.parseInt(VariabileMonitored_Valore_1.getText().toString());
						}
