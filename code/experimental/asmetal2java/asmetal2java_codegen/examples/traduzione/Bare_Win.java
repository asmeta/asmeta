...
private void initialize() {
		...
		JLabel VariabileControlled_Text_1 = new JLabel("controlledFunction1");
		...
		JLabel VariabileControlled_Text_2 = new JLabel("controlledFunction4");
		...
		JLabel VariabileControlled_Text_3 = new JLabel("controlledFunction5");
		...
		btnEsegui.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						try {
							VariabileControlled_Valore_1.setText(esecuzione.controlledFunction1.get().toString());
						...
						try {
							VariabileControlled_Valore_2.setText(esecuzione.controlledFunction4.get().toString());
						...
						try {
							VariabileControlled_Valore_3.setText(esecuzione.controlledFunction5.get().value.toString());
