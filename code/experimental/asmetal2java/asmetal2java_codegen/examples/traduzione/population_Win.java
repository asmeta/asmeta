...
public class population_Win {

	population esecuzione;
	int stato = 0;
	JFrame frame;
...
public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
				public void run() {
						try {
							population_Win window = new population_Win();
	 ...
	 */
public population_Win() {

		esecuzione = new population();
		initialize();
	}
...
private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("population ASM -> Java");
