	...
	private void initialize() {
		...
		btnEsegui.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					VariabileControlled_Valore_1_1
							.setText(esecuzione.position.oldValues.get(esecuzione.Actors_lista.get(0)).toString());
				} catch (NullPointerException errC01) {
					VariabileControlled_Valore_1_1.setText("null");
				}
				try {
					VariabileControlled_Valore_1_2
							.setText(esecuzione.position.oldValues.get(esecuzione.Actors_lista.get(1)).toString());
				} catch (NullPointerException errC01) {
					VariabileControlled_Valore_1_2.setText("null");
				}
				try {
					VariabileControlled_Valore_1_3
							.setText(esecuzione.position.oldValues.get(esecuzione.Actors_lista.get(2)).toString());
				} catch (NullPointerException errC01) {
					VariabileControlled_Valore_1_3.setText("null");
				}
				try {
					VariabileControlled_Valore_1_4
							.setText(esecuzione.position.oldValues.get(esecuzione.Actors_lista.get(3)).toString());
				} catch (NullPointerException errC01) {
