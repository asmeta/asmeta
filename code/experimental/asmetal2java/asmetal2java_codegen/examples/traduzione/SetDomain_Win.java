...
public class SetDomain_Win {
	SetDomain esecuzione;
	int stato = 0;
	JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SetDomain_Win window = new SetDomain_Win();
	 ...
	 */
	public SetDomain_Win() {
		esecuzione = new SetDomain();
		initialize();
	}
	...
	private void initialize() {
		...
		frame = new JFrame();
		//Titolo 
		frame.setTitle("SetDomain ASM -> Java");
