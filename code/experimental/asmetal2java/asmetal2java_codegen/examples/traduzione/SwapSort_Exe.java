// SwapSort_Exe.java automatically generated from ASM2CODE
...
class SwapSort_Exe {
	...
	static void printControlled(SwapSort esecuzione) {

	}

	static void askMonitored(SwapSort esecuzione) {

	}

public static void main(String[] args) {

		System.out.println("INFO - file java creto e tradotto dal file originale SwapSort.asm");
		System.out.println("Inizio esecuzione del file SwapSort.java\n\n");

		SwapSort esecuzione = new SwapSort();
