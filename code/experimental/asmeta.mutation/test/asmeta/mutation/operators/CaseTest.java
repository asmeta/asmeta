...
public class CaseTest {
	...
	public void testMutatate() throws Exception {
		...
		String string = "examples/SiGistica.asm";
		...
		List<AsmCollection> mutrul = new CaseMutator().mutate(asmeta);
		System.out.println("-------    mutation applied   -------\n\n");
		//amPrint.visit(mutrul.get(3).getMain().getMainrule());
		amPrint.visit(mutrul.get(4).getMain());
