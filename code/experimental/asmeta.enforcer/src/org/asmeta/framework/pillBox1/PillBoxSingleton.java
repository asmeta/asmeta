...
public class PillBoxSingleton extends ManagedSystem implements Probe, Effector{
	...
	public PillBoxSingleton(String model_path) {
	...
	**/
	...
	//Example of input cmd: systemTime 412 openSwitch(compartment2) false openSwitch(compartment3) false openSwitch(compartment4) false 
		public static void main(String[] args) {	
	        PillBoxSingleton p = new PillBoxSingleton("examples/pillbox/pillbox.asm");	
