...
/**
 * Represents a set term in the Avalla language, which holds a name and a
 * corresponding value.
 * <p>
 * This class is used to define a term with a specific name and value, typically
 * representing a setting or configuration within a scenario in the Avalla
 * framework.
 * </p>
 */
public class AvallaSetTerm extends AvallaTerm {
	...
	/**
	 * Default constructor for the {@code AvallaSetTerm} class. Initializes an empty
	 * {@code AvallaSetTerm} with no name or value.
	 */
