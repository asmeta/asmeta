...
/**
 * Represents a header term in the Avalla language, which holds the name of a
 * scenario.
 * <p>
 * This class stores a scenario name and provides methods to retrieve and modify
 * it. It is typically used to specify the header information of a scenario
 * within the Avalla language.
 * </p>
 */
