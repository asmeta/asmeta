...
/**
 * Represents a check term in the Avalla language, which compares two terms: a
 * left term and a right term.
 * <p>
 * This class stores two string values: the left term and the right term, and
 * provides methods to retrieve and modify these values.
 * </p>
 */
public class AvallaCheckTerm extends AvallaTerm {
	...
	/**
	 * Constructs an {@code AvallaCheckTerm} with the specified left and right
	 * terms.
	 *
