...
5. Customize execution with additional options:
   ...
   ```
    ...
    - `-choiceTrace` : The optional `.choices.properties` file generated by EvoSuite.
...
| `-choiceTrace`     | String            | Path to the optional `.choices.properties` file generated by EvoSuite.       |
