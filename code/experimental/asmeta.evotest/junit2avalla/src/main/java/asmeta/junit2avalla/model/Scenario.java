package asmeta.junit2avalla.model;
 ...
 *
 * <p>
 * The validity of the scenario is updated when an {@link AvallaStepTerm} is added to the scenario,
 * and it uses a {@link LinkedList} internally to maintain the order of the terms.
 * </p>
 */
public class Scenario {
   ...
   *
   * <p>If the term is an instance of {@link AvallaStepTerm}, the scenario is marked as valid.</p>
   *
  ...
  /**
   * Returns whether the scenario is valid, i.e., contains at least one {@link AvallaStepTerm}.
   *
