      ...
      if ((fd instanceof ControlledFunction)) {
        ...
        if (_tripleEquals) {
                      ...
                      if (_equals_3) {
                        ...
                        if (_equals_4) {
                          ...
                          if (_equals_5) {
                            ...
                            String _name_18 = ((ControlledFunction)fd).getCodomain().getName();
                            String _plus = ("Domain not supported: " + _name_18);
          ...
          for (final Domain dd : _domain_2) {
            boolean _equals_6 = dd.equals(((ControlledFunction)fd).getDomain());
            if (_equals_6) {
                ...
                for (int i = 0; (i < ((EnumTd)dd).getElement().size()); i++) {
                  {
                    ...
                    if ((_codomain_4 instanceof ConcreteDomain)) {
                      ...
                      _append_1.append(_builder_9);
                      sb.append(System.lineSeparator());
                      StringBuffer _append_2 = sb.append("\t\t\t");
                      StringConcatenation _builder_10 = new StringConcatenation();
                      _builder_10.append("this.execution.");
                      String _name_21 = ((ControlledFunction)fd).getDomain().getName();
                      ...
                      if ((_codomain_5 instanceof AbstractTd)) {
                        ...
                        _append_6.append(_builder_14);
                        sb.append(System.lineSeparator());
                        StringBuffer _append_7 = sb.append("\t\t");
                        StringConcatenation _builder_15 = new StringConcatenation();
                        _builder_15.append("return value != null ? \"abstract_\" + value : null;");
                        _append_7.append(_builder_15);
                        sb.append(System.lineSeparator());
                        StringBuffer _append_8 = sb.append("\t");
                        StringConcatenation _builder_16 = new StringConcatenation();
                        _builder_16.append("}");
                        _append_8.append(_builder_16);
                      } else {
                        ...
                        _builder_17.append("return this.execution.");
                        String _name_25 = ((ControlledFunction)fd).getName();
                        _builder_17.append(_name_25);
                        _builder_17.append(".get(");
                        _append_9.append(_builder_17);
                        sb.append(System.lineSeparator());
                        ...
                        _builder_18.append("_elemsList.get(");
                        _builder_18.append(i);
                        _builder_18.append("));");
                        _append_10.append(_builder_18);
                        sb.append(System.lineSeparator());
                        StringBuffer _append_11 = sb.append("\t");
                        StringConcatenation _builder_19 = new StringConcatenation();
                        _builder_19.append("}");
                        _append_11.append(_builder_19);
                      }
                    }
                    sb.append(System.lineSeparator());
                  }
                      ...
                      if ((((StaticFunction)sf).getCodomain().equals(dd) && (((StaticFunction)sf).getDomain() == null))) {
                        ...
                        if ((_codomain_4 instanceof ConcreteDomain)) {
                          ...
                          if ((_codomain_5 instanceof AbstractTd)) {
                            ...
                            String methodGetterSignature = "get_".concat(((ControlledFunction)fd).getName()).concat(
                  ...
                  if ((dd instanceof ConcreteDomain)) {
                    ...
                    for (final Domain cd_1 : _domain_3) {
                      if ((cd_1 instanceof ConcreteDomain)) {
                        boolean _equals_7 = ((ConcreteDomain)cd_1).getName().equals(((ControlledFunction)fd).getDomain().getName());
                        if (_equals_7) {
                          ...
                          for (final String elem : elems) {
                            {
                              ...
                              if ((_codomain_6 instanceof ConcreteDomain)) {
                                ...
                                _builder_20.append("public ");
                                _builder_20.append(originalDomain);
                                ...
                                if ((_codomain_7 instanceof AbstractTd)) {
                                  ...
                                  _builder_24.append("public String get_");
                                  String _name_30 = ((ControlledFunction)fd).getName();
                                  _builder_24.append(_name_30);
                                  _builder_24.append("_fromDomain_");
                                  _builder_24.append(elem);
                                  _builder_24.append("(){");
                                  _append_16.append(_builder_24);
                                  sb.append(System.lineSeparator());
                                  ...
                                  _builder_25.append(".get(");
                                  _append_17.append(_builder_25);
                                  sb.append(System.lineSeparator());
                                  ...
                                  _builder_26.append(".valueOf(");
                                  _builder_26.append(symbol_1);
                                  _builder_26.append(")).toString();");
                                  _append_18.append(_builder_26);
                                  sb.append(System.lineSeparator());
                                  StringBuffer _append_19 = sb.append("\t");
                                  StringConcatenation _builder_27 = new StringConcatenation();
                                  _builder_27.append("}");
                                  _append_19.append(_builder_27);
                                } else {
                                  String methodGetterSignature_1 = "get_".concat(((ControlledFunction)fd).getName()).concat(
                                    "_fromDomain_").concat(elem);
                                  sb.append(
                                    AsmMethodsUtil.getMethodSignature(asmName, methodGetterSignature_1, ((ControlledFunction)fd).getCodomain().getName()));
                                  sb.append(System.lineSeparator());
                    ...
                    String _name_27 = ((ControlledFunction)fd).getCodomain().getName();
                    String _plus_1 = ("Domain not supported: " + _name_27);
              ...
              if ((_codomain_2 instanceof AbstractTd)) {
                ...
                if ((_codomain_3 instanceof SequenceDomain)) {
                  ...
                  if (((((((MonitoredFunction)fd).getCodomain().getName().equals(AsmMethods.INTEGER) || ((MonitoredFunction)fd).getCodomain().getName().equals(AsmMethods.BOOLEAN)) || 
                    ...
                    String _name_30 = ((MonitoredFunction)fd).getCodomain().getName();
                    String _plus = ("Domain not supported: " + _name_30);
                    InputOutput.<String>println(_plus);
                  }
                }
              }
            ...
            for (int i = 0; (i < ((EnumTd)dd).getElement().size()); i++) {
              {
                ...
                if ((_codomain_4 instanceof ConcreteDomain)) {
                  ...
                  _builder_4.append(".");
                  String _name_35 = ((EnumTd)dd).getName();
                  ...
                  if ((_codomain_5 instanceof EnumTd)) {
                    ...
                    String _name_47 = asm.getName();
                    _builder_5.append(_name_47, "\t");
                    _builder_5.append(".");
                    String _name_48 = ((EnumTd)dd).getName();
                    ...
                    if ((_codomain_6 instanceof AbstractTd)) {
                      ...
                      String _name_55 = asm.getName();
                      _builder_6.append(_name_55, "\t");
                      _builder_6.append(".");
                      String _name_56 = ((EnumTd)dd).getName();
                      ...
                      _builder_6.newLineIfNotEmpty();
                      _builder_6.append("\t");
                      String _name_57 = asm.getName();
                      _builder_6.append(_name_57, "\t");
                      _builder_6.append(".");
                      String _name_58 = ((MonitoredFunction)fd).getCodomain().getName();
                      ...
                      String _name_65 = asm.getName();
                      _builder_7.append(_name_65, "\t");
                      _builder_7.append(".");
                      String _name_66 = ((EnumTd)dd).getName();
            ...
            if ((_domain_2 instanceof AbstractTd)) {
                    ...
                    if ((_codomain_4 instanceof ConcreteDomain)) {
                      ...
                      if ((_codomain_5 instanceof EnumTd)) {
                        ...
                        if ((_codomain_6 instanceof AbstractTd)) {
                          ...
                          _builder_7.append(_name_65, "\t");
                          _builder_7.append(".");
                          String _name_66 = ((MonitoredFunction)fd).getDomain().getName();
                          _builder_7.append(_name_66, "\t");
                          _builder_7.append(".get(\"");
                          _builder_7.append(symbol, "\t");
                          _builder_7.append("\"),");
              ...
              if ((_domain_3 instanceof ConcreteDomain)) {
                ...
                for (final Domain cd_1 : _domain_4) {
                  if ((cd_1 instanceof ConcreteDomain)) {
                    boolean _equals_1 = ((ConcreteDomain)cd_1).getName().equals(((MonitoredFunction)fd).getDomain().getName());
                    if (_equals_1) {
                      final String elemsString = new TermToJava(asm).visit(((ConcreteDomain)cd_1).getDefinition().getBody());
                      final Function1<String, String> _function_2 = (String it) -> {
                        int _lastIndexOf = it.lastIndexOf(".");
                      ...
                      for (final String elem : elems) {
                        {
                          ...
                          if ((_codomain_7 instanceof ConcreteDomain)) {
                            ...
                            _builder_8.newLineIfNotEmpty();
                            _builder_8.append("\t");
                            String _name_73 = asm.getName();
                            _builder_8.append(_name_73, "\t");
                            _builder_8.append(".");
                            String _name_74 = ((MonitoredFunction)fd).getDomain().getName();
                            ...
                            _builder_8.newLineIfNotEmpty();
                            _builder_8.append("\t");
                            String _name_75 = asm.getName();
                            _builder_8.append(_name_75, "\t");
                            _builder_8.append(".");
                            String _name_76 = ((MonitoredFunction)fd).getCodomain().getName();
                            ...
                            if ((_codomain_8 instanceof EnumTd)) {
                              ...
                              _builder_9.append(".");
                              String _name_82 = ((MonitoredFunction)fd).getCodomain().getName();
                              ...
                              _builder_9.newLineIfNotEmpty();
                              _builder_9.append("\t");
                              String _name_85 = asm.getName();
                              _builder_9.append(_name_85, "\t");
                              _builder_9.append(".");
                              String _name_86 = ((MonitoredFunction)fd).getDomain().getName();
                              ...
                              if ((_codomain_9 instanceof AbstractTd)) {
                                ...
                                _builder_10.newLineIfNotEmpty();
                                _builder_10.append("\t");
                                String _name_93 = asm.getName();
                                _builder_10.append(_name_93, "\t");
                                _builder_10.append(".");
                                String _name_94 = ((MonitoredFunction)fd).getDomain().getName();
                                ...
                                _builder_10.newLineIfNotEmpty();
                                _builder_10.append("\t");
                                String _name_95 = asm.getName();
                                _builder_10.append(_name_95, "\t");
                                _builder_10.append(".");
                                String _name_96 = ((MonitoredFunction)fd).getCodomain().getName();
                                ...
                                _builder_11.newLineIfNotEmpty();
                                _builder_11.append("\t");
                                String _name_103 = asm.getName();
                                _builder_11.append(_name_103, "\t");
                                _builder_11.append(".");
                                String _name_104 = ((MonitoredFunction)fd).getDomain().getName();
